...
<div>
	<a href="complaint.jsp?id=<%=question_id%>">Have a complaint regarding this question?</a>
</div>
...
<form method="post" action="post_answer_comment.jsp?question_id=<%=question_id %>">
	<div>
        <strong><p style="padding: 25px; border-top: 1px solid silver;">Hello <%=session.getAttribute("first_name") %>, be specific before the discussions:</p></strong>
    </div><br>
        <div>
        <div>
        ...
        <input type="submit" value="Submit Answer or comment"/>
        </div>
</form>

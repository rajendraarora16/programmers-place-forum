...
try{
    ...
    String sql="select * from login_system where user_id='"+user_id+"'";
...
<link href='http://fonts.googleapis.com/css?family=Open+Sans:400,600,700|Pacifico' rel='stylesheet' type='text/css'>
  <title><%=first_name%>'s Profile View</title>
...
<script>
   ...
   <div id="Frame">
      ...
      <img src="./logo/discussion_logo.png" class="ProfilePhotoLarge" />   </div>
		<h1 class="H" style="text-align: center;"><%=first_name%> <%=last_name%><span class="Gloss"></span></h1>
            </div>
...
<div class="Profile">
   ...
   <dl class="About">
      ...
      <dd class="Name" itemprop="name"><%=email%></dd>

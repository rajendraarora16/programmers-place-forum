      ...
      <div id="Body">
         <div class="container">
            ...
            <div class="Column ContentColumn" id="Content" style="width: 100%;">
            	<h2>Hi, <%=welcome_name %>!</h2>
            	<p>Many users are still looking for the correct answers, help them. Or ask your own question from <a href="./askQuestion.jsp">here</a>.</p><br>
...
%>
   ...
   <div class="ItemContent Discussion">
      <div class="Title">
      	<a style="font-size:20px;" href="showThread.jsp?id=<%=thread_id%>"><%=thread_title%></a>      
      </div>
